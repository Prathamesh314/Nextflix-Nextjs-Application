        ...
        <div className='flex mt-2'>
            <div className='flex items-center justify-center mr-8'>
                <div className='flex bg-white rounded-lg mr-3'>
                    <input type='text' className='block sm:w-[300px] font-serif rounded-2xl p-2 outline-none text-black' placeholder='Search...' onChange={(e)=>setSearchTerm(e.target.value)}/>
