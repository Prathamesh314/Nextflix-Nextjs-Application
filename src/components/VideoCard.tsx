...
const VideoCard = ({title}:{title:string}) => {
  ...
  return (
    <div className='flex flex-col h-60 w-60 rounded-md hover:scale-105  transition-all bg-gray-900 shadow-lg shadow-blue-950 p-[10px] justify-around' onClick={handleOnClick}>
